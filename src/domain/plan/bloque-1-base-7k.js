...
//            partida: la prueba de S1, que no se cronometra.
...
export const WEEKS = [
  ...
  { n: 11, fase: "OBJETIVO", sinDeficit: true,
    days: [
      ...
      { dow: "Domingo", tipo: "objetivo", cat: "runQ", titulo: "7KM A 4:45/km — EL DÍA", dur: "~33:15", rpe: "8-9/10", ritmo: 285,
        prueba: { distKm: 7 },
