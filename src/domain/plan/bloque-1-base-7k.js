 ...
 *
 * Mover el bloque entero de fecha = cambiar esta constante. Nada mas.
 *
 * El dia 0 de cada semana es lunes, y esa posicion es la que manda: el campo
 * `dow` es solo etiqueta legible. Si algun dia el bloque empieza en un dia que
 * no sea lunes, se ajusta en el calendario, no aqui.
 */
...
export const WEEKS = [
  { n: 1, fase: "RAMPA",
    days: [
      { dow: "Lunes", tipo: "libre", cat: "descanso", titulo: "Tenis — compromiso fijo" },
      { dow: "Martes", tipo: "run", cat: "runZ2", titulo: "Correr/Caminar", dur: "25 min", rpe: "3/10",
        what: "6x[90s correr / 2min caminar].", intervalos: [{r:6,s:[["correr",90],["caminar",120]]}] },
      { dow: "Miercoles", tipo: "fuerza", cat: "empuje", titulo: "Empuje + Tiron (rampa) - Pecho / Espalda / Hombro", dur: "35 min",
        ejercicios: [
      ...
      { dow: "Jueves", tipo: "run", cat: "runZ2", titulo: "Segunda salida", dur: "25 min", rpe: "3/10",
        what: "6x[90s correr / 2min caminar].", intervalos: [{r:6,s:[["correr",90],["caminar",120]]}] },
      { dow: "Viernes", tipo: "fuerza", cat: "pierna", titulo: "Pierna + Core (rampa)", dur: "30 min",
        ejercicios: [
      ...
      { dow: "Sabado", tipo: "libre", cat: "descanso", titulo: "Descanso - rampa de entrada" },
  ...
  { n: 2, fase: "RAMPA",
    days: [
      { dow: "Lunes", tipo: "libre", cat: "descanso", titulo: "Tenis — compromiso fijo" },
      { dow: "Martes", tipo: "run", cat: "runZ2", titulo: "Intervalos 3 min", dur: "30 min", rpe: "4/10",
        what: "5x[3min correr / 90s caminar].", intervalos: [{r:5,s:[["correr",180],["caminar",90]]}] },
      { dow: "Miercoles", tipo: "fuerza", cat: "tiron", titulo: "Tiron + Hombro (rampa)", dur: "40 min",
        ejercicios: [
      ...
      { dow: "Jueves", tipo: "run", cat: "runZ2", titulo: "Repetir martes", dur: "30 min", rpe: "4/10",
        what: "5x[3min correr / 90s caminar].", intervalos: [{r:5,s:[["correr",180],["caminar",90]]}] },
      { dow: "Viernes", tipo: "fuerza", cat: "empuje", titulo: "Empuje (rampa)", dur: "40 min",
        ejercicios: [
  ...
  { n: 6, fase: "CALIDAD",
    days: [
      { dow: "Lunes", tipo: "libre", cat: "descanso", titulo: "Tenis — compromiso fijo" },
      { dow: "Martes", tipo: "run", cat: "runQ", titulo: "Ritmo especifico 3km", dur: "38 min", rpe: "7/10", esCalidad: true,
        what: "3km a 5:20-5:35/km." },
      { dow: "Miercoles", tipo: "fuerza", cat: "empuje", titulo: "Tiron + Hombro + Empuje", dur: "60 min",
        ejercicios: [
      ...
      { dow: "Jueves", tipo: "run", cat: "runZ2", titulo: "Z2 asimilacion", dur: "40 min", rpe: "5/10",
        what: "30 min Z2." },
      { dow: "Viernes", tipo: "fuerza", cat: "empuje", titulo: "Hombro + Biceps", dur: "40 min",
        ejercicios: [
  ...
  { n: 7, fase: "ESPECIFICIDAD",
    days: [
      { dow: "Lunes", tipo: "libre", cat: "descanso", titulo: "Tenis — compromiso fijo" },
      { dow: "Martes", tipo: "run", cat: "runQ", titulo: "Ritmo 4km", dur: "40 min", rpe: "7-8/10", esCalidad: true,
        what: "4km a 5:05-5:15/km." },
      { dow: "Miercoles", tipo: "fuerza", cat: "empuje", titulo: "Tiron + Hombro + Empuje", dur: "55 min",
        ejercicios: [
      ...
      { dow: "Jueves", tipo: "run", cat: "runZ2", titulo: "Z2 asimilacion", dur: "40 min", rpe: "5/10",
        what: "30 min Z2." },
      { dow: "Viernes", tipo: "fuerza", cat: "empuje", titulo: "Hombro + Biceps (reducir)", dur: "30 min",
        ejercicios: [
          { grupo: "Hombro", nombre: "Elevaciones laterales polea muñequera cruzadas", series: "3xfallo" },
  ...
  { n: 8, fase: "ESPECIFICIDAD",
    days: [
      { dow: "Lunes", tipo: "libre", cat: "descanso", titulo: "Tenis — compromiso fijo" },
      { dow: "Martes", tipo: "run", cat: "runQ", titulo: "5km a ritmo objetivo", dur: "45 min", rpe: "8/10", esCalidad: true,
        what: "5km a 4:55-5:00/km." },
      { dow: "Miercoles", tipo: "fuerza", cat: "empuje", titulo: "Tiron ligero + Empuje", dur: "30 min",
        ejercicios: [
      ...
      { dow: "Jueves", tipo: "run", cat: "runZ2", titulo: "Z2 suave", dur: "38 min", rpe: "5/10",
        what: "28 min Z2 suave." },
      { dow: "Viernes", tipo: "libre", cat: "descanso", titulo: "Descanso total" },
      { dow: "Sabado", tipo: "run", cat: "runZ2", titulo: "Activacion 15 min", dur: "15 min", rpe: "2/10",
  ...
  { n: 9, fase: "ESPECIFICIDAD",
    days: [
      { dow: "Lunes", tipo: "libre", cat: "descanso", titulo: "Tenis — compromiso fijo" },
      { dow: "Martes", tipo: "run", cat: "runQ", titulo: "3km exactos a 4:45/km", dur: "35 min", rpe: "8-9/10", esCalidad: true,
        what: "3km a 4:45/km exactos." },
      { dow: "Miercoles", tipo: "fuerza", cat: "empuje", titulo: "Tiron ligero + Empuje", dur: "25 min",
        ejercicios: [
      ...
      { dow: "Jueves", tipo: "run", cat: "runZ2", titulo: "Activacion suave", dur: "32 min", rpe: "4/10",
  ...
  { n: 10, fase: "TAPER",
    days: [
      { dow: "Lunes", tipo: "libre", cat: "descanso", titulo: "Descanso - inicio taper" },
      { dow: "Martes", tipo: "run", cat: "runZ2", titulo: "Activacion suave", dur: "25 min", rpe: "3/10",
      ...
      { dow: "Jueves", tipo: "run", cat: "runQ", titulo: "Progresivos", dur: "20 min", rpe: "3-4/10",
        what: "10 min trote suave + 4x100m progresivos." },
      { dow: "Viernes", tipo: "libre", cat: "descanso", titulo: "Descanso total" },
      { dow: "Sabado", tipo: "run", cat: "runZ2", titulo: "Activacion", dur: "20 min", rpe: "2-3/10",
        what: "15 min trote suave." },
      { dow: "Domingo", tipo: "run", cat: "runZ2", titulo: "Ultimo ensayo largo suave", dur: "35 min", rpe: "4/10",
        what: "5km a ritmo comodo, sin forzar. Ultima semana antes del taper final." },
    ]},
  { n: 11, fase: "OBJETIVO",
    days: [
      { dow: "Lunes", tipo: "libre", cat: "descanso", titulo: "Descanso - taper final" },
      { dow: "Martes", tipo: "run", cat: "runZ2", titulo: "Activacion minima", dur: "20 min", rpe: "2-3/10",
      ...
      { dow: "Sabado", tipo: "run", cat: "runZ2", titulo: "Activacion final", dur: "15 min", rpe: "2/10",
        what: "10 min jogging muy suave." },
      { dow: "Domingo", tipo: "objetivo", cat: "runQ", titulo: "7KM A 4:45/km - EL DIA", dur: "~33:15", rpe: "8-9/10",
